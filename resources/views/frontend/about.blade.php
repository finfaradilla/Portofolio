...
@section('content')
      ...
      <div class="container carousel carousel-fade">
          <div class="carousel-item  active ">
              <div class="carousel-container">
                <h2 class="h2-title">Welcome to <span>GearGeek Hub</span></h2>
    ...
    <div id="about" class="container text-white about">
    ...
    <div class="row justify-content-center pb-5">
        <div class="col-lg-2 col-md-6">
            <div class="team-item text-center">
                <img class="img-fluid" src="https://i.pinimg.com/564x/26/6f/a4/266fa493f376bfd7e341b11e273f83c4.jpg" st alt="">
                <div class="team-text">
        ...
        <div class="col-lg-2 col-md-6">
            <div class="team-item text-center">
                <img class="img-fluid" src="https://i.pinimg.com/564x/26/6f/a4/266fa493f376bfd7e341b11e273f83c4.jpg" alt="">
                <div class="team-text">
                    <div class="team-title">
